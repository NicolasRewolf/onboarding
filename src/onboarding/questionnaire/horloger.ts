...
const FONTS: FontOption[] = [
  ...
  // Sans moderne — net, « figma »
  { name: "Inter Tight", stack: "'Inter Tight', system-ui, sans-serif" },
  ...
  // Display — caractère, « laser »
  { name: "Syne", stack: "'Syne', system-ui, sans-serif" },
  { name: "Unbounded", stack: "'Unbounded', system-ui, sans-serif" },
  { name: "Bricolage Grotesque", stack: "'Bricolage Grotesque', system-ui, sans-serif" },
];
...
export const HORLOGER_RAW: RawSection[] = [
  ...
  {
    t: "Adresse, horaires & accès",
    d: "La base du référencement local : où te trouver, quand, et comment on passe te voir.",
    qs: [
      { id: "g10", p: "E", type: "boolean", label: "Les clients peuvent-ils passer à l'atelier sans rendez-vous ?", why: "Question fréquente côté client — une réponse nette évite les visites à vide et cadre la page accès / contact." },
      { id: "g11", p: "E", type: "text", label: "Tes horaires d'ouverture ?", why: "Horaires + carte = conversion locale.", ph: "Lun-Ven 9h-18h, samedi sur RDV…" },
    ],
  },
  {
    t: "Marques & agréments",
    ...
    qs: [
      ...
      { id: "g14", p: "E", type: "multi", label: "Quelles marques mettre en avant en priorité ?", why: "Seuls 2 concurrents font des pages par marque — territoire quasi vierge.", options: ["Rolex", "Omega", "Tudor", "TAG Heuer", "Tissot", "Longines", "Hamilton", "Seiko", "Cartier", "Breitling"], allowOther: true },
  ...
  },
  {
    ...
    qs: [
      ...
      { id: "g18", p: "E", type: "booleanDetail", label: "On affiche des tarifs au public (« à partir de X€ ») ? Et les tarifs pro, on les gère comment ?", why: "Seuls 6% des sites affichent un prix, alors que « tarif » est LA question posée — premier à le faire = capte le clic. Reste à trancher le public et le pro.", detailPh: "Quels actes afficher / garder « sur devis » ? Tarifs pro : grille dédiée, sur devis, ou non affichés ?" },
